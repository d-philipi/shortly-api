...
import { deleteUrlValidation, urlValidation } from "../middlewares/urlValidationMiddleware.js";
...
router.delete("/urls/:id", authValidation, deleteUrlValidation, deleteUrl);
